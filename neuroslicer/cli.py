...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--use-hf", action="store_true", help="Force-enable HF API request (legacy flag)")
    parser.add_argument("--no-hf", action="store_true", help="Disable HF API request")
...
def main() -> None:
    ...
    engine = DiagnosticEngine(kb, hf_config=hf_config)
    use_hf = (hf_config.enabled and not args.no_hf) or args.use_hf
